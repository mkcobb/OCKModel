...
[pathX,pathY,pathZ] = sphere2cart(plant.initialRadius,pathAzimuth,pathZenith);
...
% h.waypoints = scatter3(pathX(round(plant.waypointPathIndices*plant.num)),...
%     pathY(round(plant.waypointPathIndices*plant.num)),...
%     pathZ(round(plant.waypointPathIndices*plant.num)),...
