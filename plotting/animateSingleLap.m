...
for ii = 1:length(tsc.time)
    ...
    if ii == 1
        ...
        h.targetWaypoint    = scatter3(tsc.targetPointGFC.data(ii,1),...
            tsc.targetPointGFC.data(ii,2),...
            tsc.targetPointGFC.data(ii,3),...
            'MarkerFaceColor','flat','SizeData',75,'DisplayName','Carrot','CData',[1 0 0],'Parent',h.ax);
        
        % Plot the closest point
        h.closestPoint      = scatter3(tsc.closestPointGFC.data(ii,1),...
            tsc.closestPointGFC.data(ii,2),...
            tsc.closestPointGFC.data(ii,3),...
            'CData',[0 1 0],'MarkerFaceColor','flat','SizeData',75,'DisplayName','Projection','Parent',h.ax);
        ...
        data = {...
            ...
            'Gamma Wing Effective',     sprintf('%.4f',tsc.gammaWingEffective.data(ii)*180/pi),     'deg';...
            'Wing Net Long. Force',     sprintf('%.4f',tsc.fNetBFC.data(ii,1)),                     'N';...
            'Current Spatial Error',    sprintf('%.4f',tsc.signedSpatialError.data(ii)),            'm';...
            'ILC Rudder Error',         sprintf('%.4f',tsc.lowerLevelILCError.data(ii)),            'm';...
            'Gamma Rudder',             sprintf('%.4f',tsc.gammaRudder.data(ii)*180/pi),            'deg';...
            'Raw Rudder Command',       sprintf('%.4f',tsc.rudderCommandRaw.data(ii)*180/pi),       'deg';...
            'ILC Rudder Correction',    sprintf('%.4f',tsc.ILCRudderComponent.data(ii)*180/pi),     'deg';...
        ...
        h.table.Data(:,2)={...
            ...
            sprintf('%.4f',tsc.gammaWingEffective.data(ii)*180/pi);...
            sprintf('%.4f',tsc.fNetBFC.data(ii,1));...
            sprintf('%.4f',tsc.signedSpatialError.data(ii));...
            sprintf('%.4f',tsc.lowerLevelILCError.data(ii));...
            sprintf('%.4f',tsc.gammaRudder.data(ii)*180/pi);...
            sprintf('%.4f',tsc.rudderCommandRaw.data(ii)*180/pi);...
            sprintf('%.4f',tsc.ILCRudderComponent.data(ii)*180/pi);...
