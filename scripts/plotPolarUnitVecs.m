...
h.unitVecsInit = quiver3(tsc.positionGFC.data(1,1),tsc.positionGFC.data(1,2),tsc.positionGFC.data(1,3),L*tsc.rHatGFC.data(1,1)       ,L*tsc.rHatGFC.data(1,2)      ,L*tsc.rHatGFC.data(1,3),'Color','b');
...
h.unitVecsFinal=quiver3(tsc.positionGFC.data(end,1),tsc.positionGFC.data(end,2),tsc.positionGFC.data(end,3),L*tsc.rHatGFC.data(end,1)       ,L*tsc.rHatGFC.data(end,2)      ,L*tsc.rHatGFC.data(end,3),'Color','r');
