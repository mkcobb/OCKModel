...
h.BFCinit = quiver3(tsc.positionGFC.data(1,1),tsc.positionGFC.data(1,2),tsc.positionGFC.data(1,3)   ,L*tsc.BFX_GFC.data(1,1)            ,L*tsc.BFX_GFC.data(1,2),L*tsc.BFX_GFC.data(1,3),'Color','m');
...
h.BFCFinal = quiver3(tsc.positionGFC.data(end,1),tsc.positionGFC.data(end,2),tsc.positionGFC.data(end,3),L*tsc.BFX_GFC.data(end,1)          ,L*tsc.BFX_GFC.data(end,2),L*tsc.BFX_GFC.data(end,3),'Color','g');
